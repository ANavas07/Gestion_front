...
@Component({
  selector: 'app-suppliers-employee',
  templateUrl: './suppliers-employee.component.html',
  styleUrls: ['./suppliers-employee.component.css']
})
export class SuppliersEmployeeComponent implements OnInit {
